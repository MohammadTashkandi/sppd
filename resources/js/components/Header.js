            ...
            <nav className="navbar navbar-inverse" id="header-nav">
                <div className="container-fluid">
                    <div className="navbar-header" id="header-first">
                        <a onClick={this.linkClick} ref={this.logoRef} name="home"href="#"><img src={logo} id="logo"/></a>
                    </div>
                        <ul className="nav navbar-nav" id="header-middle">
                            <li className="home-link"><a onClick={this.linkClick} ref={this.homeRef} name="home"href="#" id="link-head">Home</a></li>
                            <div className="navbar-form navbar-left" action="/action_page.php">
                                <div className="input-group" id="search-bar">
                                    <input type="text" className="form-control" placeholder="Enter ID/Name" name="searchbtn" id="search-bar-bar"/>
                                    <div className="input-group-btn">
                                        <button className="btn btn-default" onClick={this.linkClick} ref={this.searchRef} name="search" id="search-bar">
